 ...
 */
export type FieldType = "heading" | "text" | "signature" | "initials" | "date" | "datenow" | "number" | "image" | "checkbox" | "multiple" | "file" | "radio" | "select" | "cells" | "stamp" | "payment" | "phone" | "verification" | "kba" | "strikethrough" | "pgp_signature" | "fingerprint";
export type DocumentStatus = "draft" | "pending" | "partially_signed" | "completed" | "voided" | "expired";
export type SignerRole = "signer" | "cosigner" | "witness" | "notary" | "steward" | "trustee";
export type SignerStatus = "pending" | "viewed" | "signed" | "declined" | "expired";
